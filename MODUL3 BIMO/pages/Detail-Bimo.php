        ...
        <div class="container">
            <div class="collapse navbar-collapse d-flex justify-content">
                <div class="navbar-nav">
                    ...
                    <a class="nav-link" href="<?php if (mysqli_num_rows($result) > 0) {echo "ListCar-Bimo.php";
                                    } else {
                                    echo "Add-Bimo.php";
                                    } ?>">MyCar</a>
                </div>
                ...
                <div class='container'>
                  <div class='row g-2'>
                    ...
                    <div class='mb-3'>
                      ...
                      <input type='text' class='form-control' id='nama' name='nama' value='" . $getDetail["nama_mobil"] . "' readonly>
                    </div>
                    <div class='mb-3'>
                      <label for='pemilikmobil' class='form-label'>Nama Pemilik</label>
                      <input type='text' class='form-control' id='pemilikmobil' name='pemilikmobil' value='" . $getDetail["pemilik_mobil"] . "' readonly>
                    </div>
                    <div class='mb-3'>
                        <label for='merkmobil' class='form-label'>Merk</label>
                        <input type='text' class='form-control' id='merkmobil' name='merkmobil' value='" . $getDetail["merk_mobil"] . "' readonly> 
                    </div>
                    <div class='mb-3'>
                        <label for='tanggal_beli'>Tanggal</label>
                        <input type='date' class='form-control' id='tanggal_beli' name='tanggal_beli' value='" . $getDetail["tanggal_beli"] . "' readonly>
                    </div>
                    <div class='mb-3'>
                        <label for='deskripsi' class='form-label'>Deskripsi</label>
                        <textarea class='form-control' id='deskripsi' name='deskripsi' rows='3' readonly>" . $getDetail["deskripsi"] . "</textarea>
                    </div>
                    <div class='mb-3'>
                        <label for='gambar' class='form-label'>Foto</label>
                        <input class='form-control' type='text' id='gambar' name='gambar' value='" . $getDetail["foto_mobil"] . "' style='height: 50px;' readonly>
                    </div>
                    <div class='mb-1'>
